...
mother_board = pygame.image.load("Snakes_ladders_big_image.png")
...
post = pygame.image.load("game_background.png")

"""initial_background = pygame.image.load("introduction_image.png")
initial_background2 = pygame.image.load("introduction_image2.jpg")
initial_background3 = pygame.image.load("introduction_image3.jpg")
initial_background4 = pygame.image.load("introduction_image4.jpg")
initial_background5 = pygame.image.load("introduction_image5.jpg")
creditations1 = pygame.image.load("owner.jpg")"""
...
def turn(sc, lefted, section):
    ...
    if sc <= 100:
        ...
        while pygame.time.get_ticks() - time_clock < 1500:
            message_display1_screen("Can't move!", 600, 100, 35, black_color)
            pygame.display.update()
...
def choice():
    ...
    while f == True:
        ...
        # Back button
        best5 = button("Back", mouse[0], mouse[1], 0, 600, 200, 50, red_color, blue_red_color, 30, 5)
        if best5 == 5:
            main_menu()
        if best1 == "s":
            playing(21)
...
def playing(best):
    ...
    while True:
                ...
                if tips == 1:
                    ...
                    if gamer1score == 100:
                        ...
                        while pygame.time.get_ticks() - time < 2000:
                            message_display1_screen("Player 1 Wins", 600, 100, 50, blue_color)
                ...
                if tips == 2:
                    ...
                    if gamer2score == 100:
                        ...
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen("Computer Wins", 600, 100, 50, black_color)
            ...
            if button1("Player 1", mouse[0], mouse[1], 100, 700, 200, 50, red_color, grey_color, 30):
                if tips == 1:
                    ...
                    if gamer1score == 100:
                        time_clock = pygame.time.get_ticks()
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen("Player 1 Wins", 600, 100, 50, black_color)
                            #pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 2", mouse[0], mouse[1], 400, 700, 200, 50, yellow_color, grey_color, 30):
                if tips == 2:
                    ...
                    if gamer2score == 100:
                        time_clock = pygame.time.get_ticks()
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen("Player 2 Wins", 600, 100, 50, black_color)
                            #pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 3", mouse[0], mouse[1], 700, 700, 200, 50, green_color, grey_color, 30):
                if tips == 3:
                    ...
                    if gamer3score == 100:
                        time_clock = pygame.time.get_ticks()
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen("Player 3 Wins", 600, 100, 50, black_color)
                            #pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 4", mouse[0], mouse[1], 1000, 700, 200, 50, blue_color, grey_color, 30):
                if tips == 4:
                    ...
                    if gamer4score == 100:
                        time_clock = pygame.time.get_ticks()
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen("Player 4 Wins", 600, 100, 50, black_color)
                            #pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
        ...
        if less:
            time_clock = pygame.time.get_ticks()
            while pygame.time.get_ticks() - time_clock < 2000:
                message_display1_screen("There's a Ladder!", 600, 100, 35, black_color)
                pygame.display.update()
        if set:
            time_clock = pygame.time.get_ticks()
            while pygame.time.get_ticks() - time_clock < 2000:
                message_display1_screen("There's a Snake!", 600, 100, 35, black_color)
                pygame.display.update()
